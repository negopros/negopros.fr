...
import { CheckCircle, ArrowRight, Target, TrendingUp, Users, Lightbulb, Handshake, FileCheck } from 'lucide-react';
...
const impactPhases = [
  {
    letter: 'I',
    title: 'IDENTIFIER',
    description: 'Cartographier les parties prenantes et leurs intérêts',
    icon: Target,
    color: '#2563EB',
  },
  {
    letter: 'M',
    title: 'MESURER',
    description: 'Évaluer les rapports de force et les enjeux',
    icon: TrendingUp,
    color: '#7C3AED',
  },
  {
    letter: 'P',
    title: 'PRÉPARER',
    description: 'Élaborer votre stratégie et vos scénarios',
    icon: Lightbulb,
    color: '#DC2626',
  },
  {
    letter: 'A',
    title: 'AGIR',
    description: 'Conduire la négociation avec méthode',
    icon: Handshake,
    color: '#EA580C',
  },
  {
    letter: 'C',
    title: 'CONCLURE',
    description: 'Formaliser et sécuriser l\'accord',
    icon: FileCheck,
    color: '#16A34A',
  },
  {
    letter: 'T',
    title: 'TRANSMETTRE',
    description: 'Capitaliser et partager les apprentissages',
    icon: Users,
    color: '#0891B2',
  },
];
