// Ce fichier contient TOUT le contenu complet de l'ebook
// Il sera importé dans ebookContent.ts

export const fullIntroductionContent = `
  <p class="text-lg">« Dans le monde des affaires, celui qui maîtrise l'art de la négociation détient un avantage concurrentiel décisif. » Cette phrase, souvent attribuée aux chercheurs de la Harvard Business School, résonne particulièrement pour les dirigeants de PME qui, chaque jour, font face à des situations de négociation critiques pour la survie et la croissance de leur entreprise.</p>
  ...
  <ul>
    <li><strong>Coût moyen d'une formation professionnelle en négociation :</strong> 2 000 à 5 000 euros</li>
    <li><strong>Gain moyen constaté sur les marges :</strong> 12 à 15% dans les 18 mois</li>
    <li><strong>ROI :</strong> Entre 500% et 1000% pour une PME de taille moyenne</li>
  </ul>
